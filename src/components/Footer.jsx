      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-4">
            Comprar online deve ser algo acessível, fácil e agradável. Essa é a visão que a Drip Store busca entregar em nossa plataforma adaptada para todas as regiões do Brasil.
          </p>
