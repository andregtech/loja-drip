...
const productsData = [
  ...
  { id: 5, name: "Asics Gel-Kayano", image: "https://webrun.com.br/wp-content/uploads/T799N.png", price: 75, category: "Tênis" },
      ...
      <section className="bg-white py-16 px-4 md:px-20 lg:px-32 flex flex-col md:flex-row items-center gap-12 relative">
        ...
        <div className="flex-1 text-center md:text-left z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-600 leading-tight mb-4">
            Air Jordan Edição Limitada
          </h2>
          <p className="text-gray-600 mb-6 max-w-lg">
            Esse Tênis é feito de couro perfurado, um modelo exclusivo inspirado nas quadras esportivas. Ele possui couro sintético para durabilidade e conforto respirável. Solado de borracha com ranhuras flexíveis no antepé para tração e flexibilidade nas principais áreas.<br/>
            Calçado disponível em todos os tamanhos.<br/>
            Oferta válida somente para esse 1º Semestre de 2026.
          </p>
